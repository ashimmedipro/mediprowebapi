...
{
    public class AdvanceRegisterReportModify
    {
        public void AdvanceRegisterReportSelect()
        {

            StringBuilder s = new StringBuilder();

            s.Append(" create procedure sp_AdvanceRegSelect(@initdate DateTime, @finaldate DateTime) ");
            s.Append(" as ");
