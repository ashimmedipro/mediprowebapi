...
{
    public class CurrentChangeReportModify
    {
        public void CurrentChangeReportSelect()
        {
            StringBuilder s = new StringBuilder();


            s.Append(" create procedure sp_CurrentChangeReportSelectByDateRange(@initdate DateTime, @finaldate DateTime) ");
            s.Append(" as ");
