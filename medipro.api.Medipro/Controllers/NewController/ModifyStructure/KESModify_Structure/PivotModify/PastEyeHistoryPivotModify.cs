...
{
    public class PastEyeHistoryPivotModify
    {
        public void PastEyeHistoryView()
        {
            StringBuilder s = new StringBuilder();

            s.Append(" create view Past_Eye_History_details_view ");
            s.Append(" as ");
            s.Append(" select title from Past_Eye_History_details ");
        ...
        public void PastEyeHistoryPivot()
        {
            StringBuilder s = new StringBuilder();


            s.Append(" create procedure sp_PastEyeHistoryPivotSelect ");
            s.Append(" as ");
            s.Append(" begin ");
            s.Append(" begin try ");
            ...
            s.Append(" FROM ");
            s.Append(" ( ");
            s.Append(" select title from Past_Eye_History_details group by title ");
            s.Append(" ) a ");
            ...
            s.Append(" p.ddate ");
            s.Append(" FROM ");
            s.Append(" Past_Eye_History_details p ");
            s.Append(" INNER JOIN Past_Eye_History_details_view c ");
