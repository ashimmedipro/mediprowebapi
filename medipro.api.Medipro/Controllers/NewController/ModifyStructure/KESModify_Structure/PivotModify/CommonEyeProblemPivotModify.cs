...
{
    public class CommonEyeProblemPivotModify
    {
        public void CommonEyeProblemView()
        {
            StringBuilder s = new StringBuilder();


            s.Append(" create view Chief_Complain_details_view ");
            s.Append(" as ");
            s.Append(" select title from Chief_Complain_details ");
        ...
        public void CommonEyeProblemPivot()
        {
            StringBuilder s = new StringBuilder();



            s.Append(" create procedure sp_ChiefComplainPivotSelect ");
            s.Append(" as ");
            s.Append(" begin ");
            s.Append(" begin try ");
            ...
            s.Append(" FROM ");
            s.Append(" ( ");
            s.Append(" select title from Chief_Complain_details group by title ");
            s.Append(" ) a ");
            ...
            s.Append(" p.ddate ");
            s.Append(" FROM ");
            s.Append(" Chief_Complain_details p ");
            s.Append(" INNER JOIN Chief_Complain_details_view c ");
