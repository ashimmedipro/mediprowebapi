...
{
    public class LabExaminationPivotModify
    {
        public void LabExaminationView()
        {
            StringBuilder s = new StringBuilder();


            s.Append(" create view LabExamination_details_view ");
            s.Append(" as ");
            s.Append(" select title from LabExamination_details ");
        ...
        public void LabExaminationPivot()
        {
            StringBuilder s = new StringBuilder();

            s.Append(" create procedure sp_LabExaminationDetailsPivotSelect ");
            s.Append(" as ");
            s.Append(" begin ");
            s.Append(" begin try ");
            ...
            s.Append(" FROM ");
            s.Append(" ( ");
            s.Append(" select title from LabExamination_details group by title ");
            s.Append(" ) a ");
            ...
            s.Append(" p.ddate ");
            s.Append(" FROM ");
            s.Append(" LabExamination_details p ");
            s.Append(" INNER JOIN LabExamination_details_view c ");
