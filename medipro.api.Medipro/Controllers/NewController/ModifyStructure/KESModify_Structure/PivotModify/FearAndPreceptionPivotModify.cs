...
{
    public class FearAndPreceptionPivotModify
    {
        public void FearAndPreceptionView()
        {
            StringBuilder s = new StringBuilder();



            s.Append(" create view FearAndPreception_details_view ");
            s.Append(" as ");
            s.Append(" select title from FearAndPreception_details ");
        ...
        public void FearAndPreceptionPivot()
        {
            StringBuilder s = new StringBuilder();


            s.Append(" create procedure sp_FearAndPreceptionPivotSelect ");
            s.Append(" as ");
            s.Append(" begin ");
            s.Append(" begin try ");
            ...
            s.Append(" FROM ");
            s.Append(" ( ");
            s.Append(" select title from FearAndPreception_details group by title ");
            s.Append(" ) a ");
            ...
            s.Append(" p.ddate ");
            s.Append(" FROM ");
            s.Append(" FearAndPreception_details p ");
            s.Append(" INNER JOIN FearAndPreception_details_view c ");
