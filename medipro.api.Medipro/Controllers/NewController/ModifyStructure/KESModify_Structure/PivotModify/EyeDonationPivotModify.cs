...
{
    public class EyeDonationPivotModify
    {
        public void EyeDonationView()
        {
            StringBuilder s = new StringBuilder();



            s.Append(" create view EyeDonation_details_view ");
            s.Append(" as ");
            s.Append(" select title from EyeDonation_details ");
        ...
        public void EyeDonationPivot()
        {
            StringBuilder s = new StringBuilder();



            s.Append(" create procedure sp_EyeDonationPivotSelect ");
            s.Append(" as ");
            s.Append(" begin ");
            s.Append(" begin try ");
            ...
            s.Append(" FROM ");
            s.Append(" ( ");
            s.Append(" select title from EyeDonation_details group by title ");
            s.Append(" ) a ");
            ...
            s.Append(" p.ddate ");
            s.Append(" FROM ");
            s.Append(" EyeDonation_details p ");
            s.Append(" INNER JOIN EyeDonation_details_view c ");
