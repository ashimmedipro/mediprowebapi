...
{
    public class OcularExaminationPivotModify
    {
        public void OcularExaminationView()
        {
            StringBuilder s = new StringBuilder();
            s.Append(" create view Ocular_Examination_details_view ");
            s.Append(" as ");
            s.Append(" select title from Ocular_Examination_details ");
        ...
        public void OcularExaminationPivot()
        {
            StringBuilder s = new StringBuilder();


            s.Append(" create procedure sp_OcularExaminationPivotSelect ");
            s.Append(" as ");
            s.Append(" begin ");
            s.Append(" begin try ");
            ...
            s.Append(" FROM ");
            s.Append(" ( ");
            s.Append(" select title from Ocular_Examination_details group by title ");
            s.Append(" ) a ");
            ...
            s.Append(" p.ddate ");
            s.Append(" FROM ");
            s.Append(" Ocular_Examination_details p ");
            s.Append(" INNER JOIN Ocular_Examination_details_view c ");
