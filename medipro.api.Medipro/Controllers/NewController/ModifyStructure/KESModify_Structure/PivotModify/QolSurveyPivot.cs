...
{
    public class QolSurveyPivot
    {
        public void QolSurveyDetailView()
        {
            StringBuilder s = new StringBuilder();

            s.Append(" create view OqlSurvey_details_view ");
            s.Append(" as ");
            s.Append(" select title from OqlSurvey_details ");
        ...
        public void QolSurveyDetailPivot()
        {

            StringBuilder s = new StringBuilder();

            s.Append(" create procedure sp_OqlSurveyDetailsPivotSelect ");
            s.Append(" as ");
            s.Append(" begin ");
            s.Append(" begin try ");
            ...
            s.Append(" FROM ");
            s.Append(" ( ");
            s.Append(" select title from OqlSurvey_details group by title ");
            s.Append(" ) a ");
            ...
            s.Append(" p.ddate ");
            s.Append(" FROM ");
            s.Append(" OqlSurvey_details p ");
            s.Append(" INNER JOIN OqlSurvey_details_view c ");
