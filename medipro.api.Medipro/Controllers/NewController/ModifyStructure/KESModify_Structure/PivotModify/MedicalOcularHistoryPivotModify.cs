...
{
    public class MedicalOcularHistoryPivotModify
    {
        public void MedicalOcularHistoryview()
        {
            StringBuilder s = new StringBuilder();
            s.Append(" create view MedicalOcularHistory_details_view ");
            s.Append(" as ");
            s.Append(" select title from MedicalOcularHistory_details ");
        ...
        public void MedicalOcularHistoryPivot()
        {
            StringBuilder s = new StringBuilder();
            s.Append(" create procedure sp_MedicalOcularHistoryDetailsPivotSelect ");
            s.Append(" as ");
            s.Append(" begin ");
            s.Append(" begin try ");
            ...
            s.Append(" FROM ");
            s.Append(" ( ");
            s.Append(" select title from MedicalOcularHistory_details group by title ");
            s.Append(" ) a ");
            ...
            s.Append(" p.ddate ");
            s.Append(" FROM ");
            s.Append(" MedicalOcularHistory_details p ");
            s.Append(" INNER JOIN MedicalOcularHistory_details_view c ");
