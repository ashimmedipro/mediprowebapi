...
{
    public class SmokingHistoryModify
    {
        public void SmokingHistoryDetailInsert()
        {
            StringBuilder s = new StringBuilder();

            s.Append(" create procedure sp_smoking_history_detailsInsert( ");
            ...
            s.Append(" insert into smoking_history_details( ");
            s.Append(" mrdno , ");
            s.Append(" title , ");
            s.Append(" result, ");
            s.Append(" tick_mark, ");
        ...
        public void SmokingHistoryDetailSelect()
        {
            StringBuilder s = new StringBuilder();

            s.Append(" create procedure sp_smoking_history_detailsSelect(@mrdno varchar(15) ='0' ) ");
            s.Append(" as ");
            s.Append(" begin ");
            s.Append(" begin try ");
            s.Append(" begin transaction ");
            ...
            s.Append(" end ");
            s.Append(" as age ");
            s.Append(" from smoking_history_details a ");
        ...
        public void SmokingHistoryDetailDelete()
        {
            StringBuilder s = new StringBuilder();

            s.Append(" create procedure sp_smoking_history_detailsDelete(@mrdno varchar(15)) ");
            s.Append(" as ");
            s.Append(" begin ");
            s.Append(" begin try ");
            s.Append(" begin transaction ");
            s.Append(" delete from smoking_history_details ");
        ...
        public void TempSmokingHistoryDetailInsert()
        {
            StringBuilder s = new StringBuilder();

            s.Append(" create procedure sp_TempSmoking_History_detailsInsert ");
            s.Append(" @title varchar(200), ");
            s.Append(" @result varchar(200) , ");
            s.Append(" @tick_mark bit , ");
            s.Append(" @userid int ");
            ...
            s.Append(" begin try ");
            s.Append(" begin transaction ");
            s.Append(" insert into TempSmoking_History_details ");
        ...
        public void TempSmokingHistoryDetailBulkInsert()
        {
            StringBuilder s = new StringBuilder();
            s.Append(" create procedure sp_TempSmoking_History_detailsBulkInsert ");
            s.Append(" @ddate datetime, ");
            s.Append(" @hospid int, ");
            s.Append(" @mrdno varchar(15), ");
            s.Append(" @userid int ");
            ...
            s.Append(" from TempSmoking_History_details where userid=@userid ");
            s.Append(" delete from TempSmoking_History_details where userid=@userid ");
            s.Append(" commit transaction ");
            s.Append(" end try ");
            s.Append(" begin catch ");
            s.Append(" declare @err_msg varchar(max), @errnunber varchar(max), @errstate varchar(max) ");
        ...
        public void TempSmokingHistoryDetailDelete()
        {
            StringBuilder s = new StringBuilder();

            s.Append(" create procedure sp_TempSmoking_History_detailsDelete @userid int ");
            s.Append(" as ");
            s.Append(" begin ");
            s.Append(" begin try ");
            s.Append(" begin transaction ");
