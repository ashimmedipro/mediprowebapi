...
{
    public class BedTransferGetInpatient_dt
    {
    ...
    public class BedTransferSelectBedRackParticular_dt
    {
        public string particular { get; set; }
    }

    public class BedTransferSelectBedRack_dt
    {
        public string bedno { get; set; }
