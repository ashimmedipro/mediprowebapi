...
{
    public class ClaimCodeGenerateReport_dt
    {
        public string bs_date { get; set; }
        public string age { get; set; }
        public int prefix { get; set; }
        public int claim_code1 { get; set; }
        public int claim_hospid { get; set; }
        public DateTime ddate1 { get; set; }
        public string inv_no { get; set; }
        public int userid { get; set; }
        public bool emergency { get; set; }
        public bool ipd { get; set; }
        public double insurance_balance { get; set; }
        ...
        public string resultcontentstring { get; set; }
